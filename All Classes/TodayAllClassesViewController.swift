...
class TodayAllClassesViewController: UIViewController, NCWidgetProviding {
...
extension TodayAllClassesViewController : UITableViewDelegate, UITableViewDataSource {

...
protocol TableViewControllerLoad { }

extension TableViewControllerLoad where Self: UITableViewController {
     ...
     */
    func setupTableViewController( className: UITableViewController, _ name: String = "" ) {
